    ...
    <div className="flex gap-2">
      <input
        ...
        className="flex-1 rounded-lg border border-gray-700 bg-gray-900 px-4 py-3 text-sm
                   placeholder-gray-500 outline-none focus:border-violet-500 focus:ring-1
                   focus:ring-violet-500 disabled:opacity-50 transition-colors"
      />
      <button
        onClick={handleClick}
        disabled={isLoading || !url.trim()}
        className="rounded-lg bg-violet-600 px-5 py-3 text-sm font-medium
